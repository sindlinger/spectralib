//+------------------------------------------------------------------+
//| DominantCycles_STFT_Kalman_Hilbert_SG_v5.mq5                        |
...
int OnInit()
  {
   ...
   IndicatorSetString(INDICATOR_SHORTNAME,"DominantCycles_STFT_Kalman_Hilbert_SG_v5");
...
int OnCalculate(const int rates_total,
                ...
                const int &spread[])
  {
   ...
   static double s_lastNormTarget=-1.0;
   if(s_lastNormMode!=(int)InpNormMode || s_lastNormWindow!=InpNormWindow || s_lastNormTarget!=InpNormTarget)
     {
      fullRecalc=true;
